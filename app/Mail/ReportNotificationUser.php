...
class ReportNotificationUser extends Mailable
{
    ...
    {
        return $this->subject('Deals團隊 收到您的檢舉通知') // 設置郵件主題
                    ->view('report-notification-user') // 指定使用名為 report-notification-user.blade.php 的視圖來渲染郵件內容
